def main():
    ...
    resnet = ConvolutionalLightningModule.load_from_checkpoint(
        checkpoint_path="checkpoints/resnet/resnet.ckpt",
        conv_model=resnet,
        lr=config.LR,
    ...
    convnet = ConvolutionalLightningModule.load_from_checkpoint(
        checkpoint_path="checkpoints/convnext/convnext.ckpt",
        conv_model=convnet,
        lr=config.LR,
        loss_fn=nn.CrossEntropyLoss(),
        metrics=metrics,
    ...
    model_medium_32 = ConvolutionalLightningModule.load_from_checkpoint(
        checkpoint_path="checkpoints/efficientnet/efficientnet.ckpt",
    ...
    rand_id = "conv_ensemble_" + rand_id
