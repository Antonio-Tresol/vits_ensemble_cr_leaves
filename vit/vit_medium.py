...
class VitMediumModel(nn.Module):
    def __init__(self, num_classes, device) -> None:
        ...
        self.vit = torchvision.models.vit_l_16(weights=pretrained_vit_weights).to(
            device
        )
        ...
        self.vit.heads = nn.Linear(in_features=1024, out_features=num_classes).to(device)
